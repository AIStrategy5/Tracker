...
function renderImmunoSubs(cos){
  ...
  (typeof IMMUNO_SUBS!=="undefined"?IMMUNO_SUBS:[]).filter(sub=>sub.key!=="gastro").forEach(sub=>{
    ...
    html+=`<div style="border-left:4px solid ${sub.key==="gastro"?(SPACECOLOR.gastroenterology||"#1f9d8f"):"var(--immuno)"};padding-left:14px;margin:20px 0">
