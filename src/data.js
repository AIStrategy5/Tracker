...
const NEURO_CINTEL = {
  ...
  ms:{
    ...
    gaps:"BTK class literacy is nascent. PIRA vs relapse-driven paradigm shift is under-taught outside academic centres. Long-term anti-CD20 monitoring evidence is thin."
  },
  nmd:{
...
const NEURO_SUPSTRAT = {
  ...
  "Takeda":{
    ...
    ask:"An Orexin Class Pre-Launch curriculum — mechanism-first, sponsor-neutral. Prepares prescribers for the paradigm shift Takeda leads."
  },
  "Bayer":{
...
const CINTEL = {
 ...
 endocrinology:{
   ...
   businessImplications:"GLP-1 market exceeds $50B+ globally by 2026 — Novo Nordisk, Lilly, Amgen all have massive launch education budgets. Oral GLP-1 race (orforglipron, oral semaglutide) creates differentiation-education demand. MASH is a new $10B+ market (resmetirom first-in-class 2024) with Madrigal + Novo Nordisk actively funding. Insurance/access barriers for GLP-1s drive managed-care education needs. Each new indication (HFpEF, CKD, OSA, MASH) expands the addressable HCP audience beyond endocrinology."
 },
 immunology:{
...
const CURATED = {
 ...
 immunology: {
   ...
   companies:[
     ...
     {name:"Celldex", type:"biotech", sub:"derm", funder:false, region:"US", drugs:"barzolvolimab (anti-KIT mAb)", stage:"Ph3 — potential CSU paradigm shift.", news:"https://ir.celldex.com/news-releases"},
